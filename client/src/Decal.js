...
DeCal</span>
  ...
  <Image src={arrow} style={{ marginLeft: "0px", marginTop: "85px" }}>
            ...
            <Grid.Row style={{ color: "#000000", textAlign: "center", lineHeight: "35px", fontSize: "29px", fontWeight: "300px", fontStyle: "normal", fontFamily: "Montserrat", marginLeft: "129px", marginRight: "128px", marginBottom: "128px" }}>
              Our goal is to educate people with little to no experience in the field about the languages, software, and other tools that data scientists across the globe use daily. We place a special emphasis on practical tools not otherwise emphasized in Berkeley academic curricula. 
            </Grid.Row>
