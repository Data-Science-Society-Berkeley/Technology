...
const leadershipCards3 = [<Card style={cardstyle}>    <Image style={imagestyle} src={charlie}  />
  <Card.Content>
...
const leadershipCards2 = [<Card style={cardstyle}>    <Image style={imagestyle} src={roshan}/>
  <Card.Content>
