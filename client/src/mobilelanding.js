...
<Grid stackable divided='vertically' style={gridoffset}>
  ...
  <Grid.Row columns={1}>
  <div style={{width:"100%",height:"293px",backgroundColor:"white",marginTop:"-13px",marginBottom:"-13px"}}>
<Grid.Column>
<div style={{fontFamily:"Montserrat",fontStyle:"normal",fontWeight:"300px",fontSize:"48px",lineHeight:"50px",color:"#000000"}}>
...
<Link to="/about">
<div style={{fontFamily:"Montserrat",fontStyle:"normal",fontWeight:"600px",fontSize:"36px",lineHeight:"44px",color:"#0376FD",height:"38px"}}>
...
<div style={{marginLeft:"0px",fontFamily:"Montserrat",fontStyle:"normal",fontWeight:"600",fontSize:"32px",lineHeight:"45px",color:"#8CD6D1"}}>
